...
import { Trash2, Clock, Terminal, MessageSquare, Edit, Plus, Play, Pause, Calendar, AlertCircle } from 'lucide-react';
import { CronJob } from '@/app/_utils/system';
import { removeCronJob, editCronJob, createCronJob } from '@/app/_server/actions/cronjobs';
                        ...
                        <div className="flex items-center gap-3">
                            ...
                            <div>
                                ...
                                <p className="text-sm text-muted-foreground">
                                    {cronJobs.length} active job{cronJobs.length !== 1 ? 's' : ''}
                                </p>
                            </div>
                        </div>
                        <Button
                ...
                <CardContent>
                    {cronJobs.length === 0 ? (
                        <div className="text-center py-16">
                            ...
                            <h3 className="text-xl font-semibold mb-3 brand-gradient">No scheduled tasks yet</h3>
                                ...
                                >
                                    <div className="flex flex-col lg:flex-row lg:items-start gap-4">
                                        ...
                                        <div className="flex-1 min-w-0 space-y-4">
                                            {/* Header with status and schedule */}
            ...
            >
                <form onSubmit={handleEditSubmit} className="space-y-6">
                    <div className="space-y-6">
                        <div>
                            <label className="block text-sm font-medium mb-3">Schedule (Cron Expression)</label>
                            <CronExpressionHelper
                                value={editForm.schedule}
                                onChange={(value) => setEditForm(prev => ({ ...prev, schedule: value }))}
                                placeholder="* * * * *"
                                showPatterns={true}
                            />
                        </div>
                    ...
                    <div className="space-y-6">
                        <div>
                            ...
                            <CronExpressionHelper
                                ...
                                onChange={(value) => setNewCronForm(prev => ({ ...prev, schedule: value }))}
                                placeholder="* * * * *"
                                showPatterns={true}
                            />
                        </div>
                            ...
                            <div className="flex gap-4 mb-4">
                                <label className="flex items-center gap-2">
                                    <input
                                        ...
                                        onChange={() => setNewCronForm(prev => ({ ...prev, isScript: false }))}
                                ...
                                <label className="flex items-center gap-2">
                                    <input
                                        ...
                                        name="taskType"
                                        checked={newCronForm.isScript}
                                        onChange={() => setNewCronForm(prev => ({ ...prev, isScript: true }))}
                                        className="text-primary"
                                    />
                        ...
                        {!newCronForm.isScript ? (
                            ...
                            <div>
                                <BashEditor
                                    ...
                                    onChange={(value) => setNewCronForm(prev => ({ ...prev, scriptContent: value }))}
                        ...
                        <div>
                            ...
                            <Input
                                ...
                                onChange={(e) => setNewCronForm(prev => ({ ...prev, comment: e.target.value }))}
                                placeholder="What does this task do?"
                            />
                        </div>
                    </div>
            ...
            >
                <div className="text-center">
                    ...
                    <div className="flex flex-col sm:flex-row gap-3 justify-center">
                        ...
                        <Button
                            variant="destructive"
                            onClick={() => jobToDelete ? handleDelete(jobToDelete.id) : undefined}
                            className="btn-destructive"
                        >
                            Delete Task
                        </Button>
